...
@RestController
@RequestMapping("/api/myodcapp-kafka")
public class MyodcappKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MyodcappKafkaResource.class);
    ...
    public MyodcappKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
